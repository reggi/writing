...
> tl;dr The app allows you to proxy mail and send it on the behalf of another `User`. Which means that the `SenderUser` never sees the `RecipientUser`'s' address.
